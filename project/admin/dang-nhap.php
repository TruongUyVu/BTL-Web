    ...
    <div class="container">
        <div class="card card-container">
            ...
            <p id="profile-name" class="profile-name-card">
            	<?php 
            		...
            		if (isset($_POST['username'])) {
            			...
            			$sql = "SELECT * FROM quan_tri WHERE Ten_dang_nhap = '$username' AND Mat_khau = '$password'";

            			$res = mysqli_query($conn,$sql);

            			if(mysqli_num_rows($res) == 1){
            				$userinfo = mysqli_fetch_assoc($res);
            				$_SESSION['admin_login'] = $userinfo;
            ...
            <form class="form-signin" method="POST">
                ...
                <input type="text" id="username" class="form-control" placeholder="Email address" required autofocus name="username">
